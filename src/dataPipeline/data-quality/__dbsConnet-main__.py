...
from framework.hosting import DataBricksConnectHostingContext
...
def main(argv):
    ...
    try:
        ...
        try:
            context = DataBricksConnectHostingContext(hostconfig).initialize()  # default logging/settings config
