...
from framework.hosting import DataBricksHostingContext, DataBricksConnectHostingContext
...
def main(argv):
    ...
    try:
        ...
        try:
            host = DataBricksConnectHostingContext(hostconfig, version=g.__version__).initialize()  # default logging/settings config
            logger = host.logger
