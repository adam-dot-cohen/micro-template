...
from runtime.router import (RouterRuntime, RouterCommand, RouterOptions)
...
def main(argv):
    ...
    try:
        ...
        try:
            runtime = RouterRuntime(RouterOptions(internal_filesystemtype=FilesystemType.dbfs, root_mount='/'))
