...
#ToDo: change interface to dataprofile(data_all_df,data_cols,profiler_class). profiler_class will be the feature functions (metrics) to be executed on the dataset (data_all_df)
